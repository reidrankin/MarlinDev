...
inline void gcode_G29() {
  ...
  case MeshSet:
    ...
    if (code_seen('Z'))
      z = code_value_axis_units(Z_AXIS)(); else {
...
inline void gcode_M149() {
  if (code_seen('C'))
    set_input_temp_units(TEMPUNIT_C); else if (code_seen('K'))
    set_input_temp_units(TEMPUNIT_K); else if (code_seen('F'))
 ...
 *    D<mm> - Diameter of the filament. Use "D0" to set units back to linear units on the E axis.
 */
